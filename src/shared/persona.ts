...
export const HOW_TO_TALK = [
  ...
  "・`/quiz` … 4択クイズ。`topic` でテーマ指定、正解と解説はネタバレ表示（`public:true` で皆に公開）",
...
export const APP_DESCRIPTION =
  "私はスー。夜、この店（AI駆動開発サーバー）のレジに立ってます。店長さんにたまに頼りますけど、できる限り、お客さんの期待に応えたいです。日本語、たまに変です。でも、宜しくお願いします。/ask で相談、/pitch で張り紙、@スー で返事します。話の中身は覚えません。来る時間だけ、覚えてます。";
